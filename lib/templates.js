...
const NAV = [
  ...
  ['경기서부', '/gyeonggi/west/'],
  ['경기동부', '/gyeonggi/east/'],
  ['도시별 안내', '/gyeonggi/cities/'],
  ['생활권', '/gyeonggi/life/'],
  ['프로그램', '/gyeonggi/program/'],
  ['이용 장소', '/gyeonggi/use/'],
...
function headerHtml(activePath) {
  ...
  <div class="container site-header__inner">
    <a class="brand" href="/gyeonggi/">간다<span class="brand__go">GO</span><span class="brand__tag">경기도 출장마사지</span></a>
  ...
  <div class="container">
    <div class="site-footer__grid">
      ...
      <div>
        <h3>바로가기</h3>
        <ul>
          <li><a href="/gyeonggi/cities/">31개 시·군 안내</a></li>
          <li><a href="/gyeonggi/life/">핵심 생활권</a></li>
          <li><a href="/gyeonggi/station/">역세권·터미널</a></li>
          <li><a href="/gyeonggi/program/">마사지 프로그램</a></li>
          <li><a href="/gyeonggi/use/">이용 장소</a></li>
          <li><a href="/gyeonggi/sitemap/">사이트맵</a></li>
        </ul>
      </div>
      <div>
        <h3>운영 정책</h3>
        <ul>
          ...
          <li><a href="/gyeonggi/policy/operation/">운영 기준</a></li>
          <li><a href="/gyeonggi/policy/privacy/">개인정보 처리방침</a></li>
          <li><a href="/gyeonggi/policy/no-illegal/">불법·선정적 서비스 불가 안내</a></li>
          <li><a href="/gyeonggi/policy/author/">작성자·검수자 안내</a></li>
...
<p>예약 확인과 연락에 필요한 최소 정보(연락처·방문 주소·예약 시간)만 확인하며, 이용 후 지체 없이 파기합니다. 자세한 기준은 <a href="/gyeonggi/policy/privacy/">개인정보 처리방침</a>에서 확인할 수 있습니다.</p>
<div class="notice-box">
  <p><strong>불법·선정적 서비스 불가 안내</strong> — 간다GO는 건전한 방문형 관리 서비스만 운영합니다. 불법·선정적 서비스는 어떤 경우에도 제공하거나 안내하지 않으며, 관련 요구 시 예약이 취소됩니다. <a href="/gyeonggi/policy/no-illegal/">전체 안내 보기</a></p>
</div>`;
}
...
<ul>${rows}</ul>
<p>코스별 기준 요금은 경기도 전 지역 동일하게 안내되며, 추가 비용 없이 있는 그대로 안내해 드립니다. ${site.pricingNote} <a href="/gyeonggi/check/travel-fee/">상세 요금 안내 보기</a></p>`;
}
...
module.exports = {
  ...
  bookingFlowHtml, pricingNoteHtml,
  site,
};
